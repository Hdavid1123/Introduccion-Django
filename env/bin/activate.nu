...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/home/harold/Documentos/Introduccion Django/env'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/home/harold/Documentos/Introduccion Django/env/bin/deactivate.nu'
